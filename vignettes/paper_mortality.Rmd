...
# NOTE: Reviewer asked to leave this figure out!
# hydrogeo_extemp_light_tb %>%
...
fig_3 <-
    ...
    ggplot2::geom_hline(ggplot2::aes(yintercept = my_mean,
                        ...
                        size = 0.5)
fig_3
ggplot2::ggsave(plot = fig_3,
                filename = "~/Desktop/fig3.jpg",
                width = 148.5, 
                height = 105,
                units = "mm")
rm(fig_3)
...
fig_4 <- 
    ...
    ggplot2::theme_bw()
fig_4
ggplot2::ggsave(plot = fig_4,
                filename = "~/Desktop/fig4.jpg",
                width = 148.5, 
                height = 105,
                units = "mm")
rm(fig_4)
...
fig_5 <- 
    ...
    ggplot2::theme_bw()
fig_5
ggplot2::ggsave(plot = fig_5,
                filename = "~/Desktop/fig5.jpg",
                width = 148.5, 
                height = 105,
                units = "mm")
rm(fig_5)
...
fig_9 <- 
    ...
    ggplot2::ggplot() +
    ggplot2::geom_sf(data = state_hex) +
    ggplot2::geom_sf(ggplot2::aes(fill = log10(fatalities))) +
...
fig_9
ggplot2::ggsave(plot = fig_9,
                filename = "~/Desktop/fig9.jpg",
                width = 148.5, 
                height = 105,
                units = "mm")
rm(fig_9)
...
hydrogeo_extemp_light_tb %>%
    ...
    ggplot2::ylab("Number of deaths") +
    ggplot2::ggtitle(
        "Number of deaths by season and cause (excluding Brumadinho & Mariana)"
        ) +
    ggplot2::theme_bw()
...
hydrogeo_extemp_light_tb %>%
    #
    # NOTE: Excude deaths from Mariana 2015 & Brumadinho 2019.
    dplyr::filter(!(death_city %in% c("310900", "314000"))) %>%
    #
    dplyr::mutate(cause = dplyr::recode(
        cause,
    ...
    ggplot2::ylab("Cumulative number of fatalities") +
    ggplot2::ggtitle(
        "Deaths by cause by month (excluding Brumadinho & Mariana)"
    ) + 
    ggplot2::theme_bw()
