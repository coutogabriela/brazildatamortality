...
ggplot2::ggplot(plot_tb,
    ...
    ggplot2::ylab("Number of fatalities") +
    ggplot2::xlab("Age group") +
    ggplot2::ggtitle("Only geohydro")


```

```{r death_by_sex_age_heatcold, echo=FALSE, fig.width = 10, fig.height = 7}
...
plot_tb <- hydrogeo_extemp_no_serrana_tb %>%
  ...
  dplyr::summarise(fatalities = dplyr::n()) %>%
  dplyr::ungroup() %>% 
    dplyr::filter(cause %in% c("heat", "cold"))
...
ggplot2::ggplot(plot_tb,
  ...
  ggplot2::ylab("Number of fatalities (women to the left, men to the right)") +
  ggplot2::xlab("Age group") +
    ggplot2::ggtitle("Only extreme temperatures")
